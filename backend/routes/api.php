...
Route::group(['middleware' => 'auth:api'], function () {
    ...
    Route::group(['prefix' => 'rooms'], function () {
        Route::get('/', 'RoomController@allChambre');
        Route::delete('/{id}', 'RoomController@destroyChambre');
        Route::get('/search', 'RoomController@searchChambre');
        Route::post('/', 'RoomController@createChambre');
        Route::match(['put', 'post'], '/{id}', 'RoomController@updateChambre');
    });
    ...
    Route::group(['prefix' => 'user_reservations'], function () {
        ...
        Route::get('/{id}/users', 'UserReservationController@findUserXReservation');
